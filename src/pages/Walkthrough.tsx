          ...
          <div className="rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="flex flex-col lg:flex-row">
              ...
              <div className="lg:w-1/2 bg-slate-50 p-8">
                <p className="text-blue-600 text-xs font-semibold uppercase tracking-widest mb-6">
                  WHAT'S INCLUDED
                </p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    <div className="bg-blue-50 rounded-lg p-2 w-9 h-9 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        The complete recovery system in your pocket.
                      </p>
                    </div>
                  </div>

                  {/* Feature: Track Pain & Progress */}
                  <div className="flex gap-3">
                    <div className="bg-blue-50 rounded-lg p-2 w-9 h-9 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Log symptoms, track trends, and see what's improving
                        over time.
                      </p>
                    </div>
                  </div>

                  {/* Feature: Structured Phases */}
                  <div className="flex gap-3">
                    <div className="bg-blue-50 rounded-lg p-2 w-9 h-9 flex items-center justify-center shrink-0">
                      <SlidersHorizontal
                        size={16}
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Guided progressions that adjust based on how you're
                        responding.
                      </p>
                    </div>
                  </div>

                  {/* Feature: Flare-Up Support */}
                  <div className="flex gap-3">
                    <div className="bg-blue-50 rounded-lg p-2 w-9 h-9 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Tools and guidance to help you navigate setbacks without
                        starting over.
                      </p>
                    </div>
                  </div>

                  {/* Feature: Built-In Accountability */}
                  <div className="flex gap-3">
                    <div className="bg-blue-50 rounded-lg p-2 w-9 h-9 flex items-center justify-center shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 text-xs">
                        Reminders and tracking to help you stay consistent and
                        confident.
                      </p>
                    </div>
                  </div>
                ...
                {/* Guarantee */}
                <div className="mt-6 mb-4 border-t border-slate-200" />
                <div className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-xs mt-0.5">
                      Try The Foot Capacity System for 60 days. If you genuinely
                      follow the structure and do not feel like you're moving in
                      the right direction, we'll make it right.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500">
                        Return to the system anytime you need structure,
                        guidance, or support.
                      </p>
                    </div>
                  </div>
